...
|------------- | ------------- | -------------|
| [**assignCollectivityIdentity**](CollectivitsApi.md#assignCollectivityIdentity) | **PATCH** /collectivities/{id}/assign-identity | Attribuer un numéro et un nom unique à une collectivité (fonctionnalité J) |
...
> CollectivityResponse assignCollectivityIdentity(id, assignIdentityRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CollectivityResponse result = apiInstance.assignCollectivityIdentity(id, assignIdentityRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CollectivitsApi#assignCollectivityIdentity");
...
|-------------|-------------|------------------|
| **200** | Numéro et nom attribués avec succès |  -  |
| **400** | Données invalides ou déjà attribuées |  -  |
